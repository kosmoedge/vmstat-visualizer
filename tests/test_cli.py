...
class TestVisualizeCommand:
    def test_visualize_active_log(self, active_log, tmp_path):
        runner = CliRunner()
    ...
    def test_visualize_example_log(self, example_log, tmp_path):
        runner = CliRunner()
...
class TestCompareCommand:
    def test_compare_cpu(self, active_log, tmp_path):
        runner = CliRunner()
    ...
    def test_compare_all(self, active_log, tmp_path):
        runner = CliRunner()
    ...
    def test_compare_with_column_filter(self, active_log, tmp_path):
        runner = CliRunner()
    ...
    def test_compare_memory_with_buff_and_cache_columns(self, standard_log, tmp_path):
        runner = CliRunner()
